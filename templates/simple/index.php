...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo($template_dir_url); ?>gcp/github.css">
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo($template_dir_url); ?>jquery-1.10.2.min.js"></script>
        <?php get_footer(); ?>

        <script type="text/javascript" src="<?php echo($template_dir_url); ?>gcp/prettify.js"></script>
